...
public class ScottsFuelsHttpRequestReceiverV2 implements Runnable {

    private final String numberOfLitres;

    public ScottsFuelsHttpRequestReceiverV2(String numberOfLitres) {
    ...
    protected String doInBackground() {
        ...
        try {
            URL url = new URL("https://order.scottsfuels.com/api/Quote/GetQuote" +
                    "?brandId=1&customerTypeId=6&statedUse=1&productCode=K&postcode=BT47%204BN&quantity=" +
...
/*            if (tableRow != null) {
            ...
            if (Integer.parseInt(numberOfLitres) == 500) {
                ...
                FileUtil.writeToFile(context, "scotts.txt", formattedDate, extractedText);
                ...
                FileUtil.writeToFile(context, weeklyComparisonPrefix+"scotts.txt", formattedDate, extractedText);
            }*/
        }
    }
